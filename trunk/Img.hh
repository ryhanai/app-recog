...
_CORBA_MODULE_BEG
  ...
  public:
    static inline Vec3_slice* alloc() { return Vec3_alloc(); }
    static inline Vec3_slice* dup(const Vec3_slice* p) { return Vec3_dup(p); }
    static inline void free(Vec3_slice* p) { Vec3_free(p); }
  };
  ...
  public:
    static inline Mat44_slice* alloc() { return Mat44_alloc(); }
    static inline Mat44_slice* dup(const Mat44_slice* p) { return Mat44_dup(p); }
    static inline void free(Mat44_slice* p) { Mat44_free(p); }
  };
